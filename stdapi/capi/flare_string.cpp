...
void printString(FLARE_string_t s) {
...
void FLARE_str_init(FLARE_string_t *s, int8_t *charSeq) {
    *s = new FLARE_string_base;
    auto *str = new std::string();
    str->assign((const char *) charSeq);
    (*s)->str = (int8_t *) str;
}

void FLARE_str_concat(FLARE_string_t s1, FLARE_string_t s2, FLARE_string_t *res) {
...
void FLARE_str_assign(FLARE_string_t s1, FLARE_string_t s2) {
...
bool FLARE_str_is_equal(FLARE_string_t s1, FLARE_string_t s2) {
